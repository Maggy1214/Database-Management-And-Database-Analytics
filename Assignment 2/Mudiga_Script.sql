...
CONSTRAINT P_DOGBREED PRIMARY KEY(BREED_ID),
...
CONSTRAINT    P_DOG_BREED_PERCENTAGE_FK  FOREIGN KEY(BREED_ID)
              REFERENCES P_DOGBREED(BREED_ID),
CONSTRAINT    P_DOG_BREED_PERCENTAGE_FK1  FOREIGN KEY(DOG_ID)
              REFERENCES P_DOG(DOG_ID),
CONSTRAINT    PERCENT_CHK  CHECK(PERCENT BETWEEN 1 AND 100)
);
